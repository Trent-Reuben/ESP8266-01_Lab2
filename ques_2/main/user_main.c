...
void app_main(void){
    ...
    //start the tasks
    xTaskCreate(gpio_on, "gpio_on", 2042, NULL, 2, NULL);
    xTaskCreate(gpio_off, "gpio_off", 2042, NULL, 3, NULL);
...
/*
______________________2a)  Round-Robin Scheduling ______________________
...
.1 = (Task 1 -> Task 2 -> Task 3)
    ...
    xTaskCreate(gpio_on, "gpio_on", 2042, NULL, 3, NULL);
    xTaskCreate(gpio_off, "gpio_off", 2042, NULL, 2, NULL);
    xTaskCreate(status_msg, "status_msg", 2042, NULL, 1, NULL);
...
.2 = (Task 1 -> Task 3 -> Task 2)
    ...
    xTaskCreate(gpio_on, "gpio_on", 2042, NULL, 3, NULL);
    xTaskCreate(gpio_off, "gpio_off", 2042, NULL, 1, NULL);
    xTaskCreate(status_msg, "status_msg", 2042, NULL, 2, NULL);
...
.5 = (Task 3 -> Task 1 -> Task 2)
    ...
    xTaskCreate(gpio_on, "gpio_on", 2042, NULL, 2, NULL);
    xTaskCreate(gpio_off, "gpio_off", 2042, NULL, 1, NULL);
    xTaskCreate(status_msg, "status_msg", 2042, NULL, 3, NULL);
